...
class TestPredictRoutes:
    ...
    @patch("app.services.predict_services.PredictService.use_models", new_callable=AsyncMock)  # adapte le chemin réel
    ...
    def test_predict_route_invalid_ville(self, mock_verify_ville):
        ...
        assert response.json()["message"] == "Erreur dans la requête de prédiction."
    ...
    def test_predict_ville_invalid(self, mock_verify_ville):
        ...
        assert response.json()["message"] == "impossible de trouver la ville"
